...
class singleFolderView:
    def __init__(self , window , directory , config: ConfigParser, *args) -> None:
        ...
        self.window.resizeEvent = self.responser
        ...
        self.name.setStyleSheet("color: {}; font-family: {}; font-size: {}".format(
        ...
        stylesheet , self.config = change_with_config(read_file("GalleryMan/sass/styles.txt") , section="singleFolder")
    ...
    def remove_self(self):    
        ...
        for i in self.args:
            ...
            a = QPropertyAnimation(opacity , b"opacity")
    ...
    def show_image(self , name):            
        ...
        self.geometry = json.loads(self.config.get("singleFolder" , "editor-imageDimension"))
        ...
        for icon , icon_color , icon_font_size , icon_family in icons:
            ...
            item.setStyleSheet("color: {}; font-size: {}px; font-family: {}".format(
                icon_color,
                icon_font_size,
                icon_family
            ))
    ...
    def save_edited(self , dir):
        ...
        os.system("mv GalleryMan/assets/processed_image.png  {}".format("{}/{}".format(
            parent,
            name
        )))
    ...
    def callback(self):
        ...
        self.ani.addAnimation(Animation.fadingAnimation(Animation , self.buttons , 200 , True))
